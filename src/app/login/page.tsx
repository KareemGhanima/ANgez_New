  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        router.push(profile?.role ? "/dashboard" : "/onboarding");
      }
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass-panel w-full max-w-sm p-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="font-orbitron text-4xl font-black text-white mb-1" style={{ textShadow: "0 0 30px rgba(168,85,247,0.7)" }}>
            ANGEZ
          </h1>
          <div className="h-0.5 w-24 mx-auto bg-gradient-to-r from-transparent via-violet-500 to-transparent mb-3" />
          <p className="text-slate-400 text-sm uppercase tracking-widest font-orbitron">Level Up Your Real Life</p>
        </div>
